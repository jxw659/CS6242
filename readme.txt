...
# Dummy Data Creation
We used the "dummy_data_creator.ipynb" notebook to create the CSV file of dummy data using the itertools library in Python. The function takes in a dictionary of columns and possible values and returns a spreadsheet with every combination of possible values for the given columns.
